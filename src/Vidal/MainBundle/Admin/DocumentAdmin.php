...
class DocumentAdmin extends Admin
{
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        $formMapper
            ...
            ->add('Interaction', null, array('label' => 'YearEdition'))
            ->add('Lactation', null, array('label' => 'YearEdition'))
            ...
            ->add('ShowGenericsOnlyInGNList', null, array('label' => 'YearEdition'))
            ->add('NewForCurrentEdition', null, array('label' => 'YearEdition'))
            ->add('CountryEditionCode', null, array('label' => 'YearEdition'))
            ...
            ->add('PharmDelivery', null, array('label' => 'Доставка / наличие'))
