...
//        $number = $number - 1;
        ...
        $testResult = array(
          0 => array(
              ...
              'text' => 'Скорее всего, у Вас не наблюдается каких-либо видимых проблем с желудочно-кишечным трактом. <a href="http://helinorm.ru/articles/pravilnoe_pitanie_zalog_zdorovogo_zheludka.html?utm_source=vidal&utm_medium=infosite&utm_content=test1&utm_campaign=helinorm" target="_blank">Правильный режим питания</a> и здоровый образ жизни, плановые профилактические визиты к врачу – залог здоровья в будущем.',
              ),
          1 => array(
              'title' => 'Результат: состояние Вашего желудочно-кишечного тракта не идеально',
              'text' => 'Проявите повышенную заботу о своем желудке. Возможно, Вам следует пересмотреть образ жизни и привычки питания. Желательно обратиться к врачу-гастроэнтерологу и пройти <a href="http://helinorm.ru/articles/kak_diagnostirovat_nalichie_khelikobakter_pilori.html?utm_source=vidal&utm_medium=infosite&utm_content=test2&utm_campaign=helinorm" target="_blank">профилактическое обследование</a>.',
          ),
          2 => array(
              'title' => 'Результат: Вам необходимо срочно обратиться к врачу.',
              'text' => 'Срочно займитесь своим здоровьем. Обязательно посетите врача-гастроэнтеролога и пройдите обследование желудочно-кишечного тракта, сдайте тест на наличие <a href="http://helinorm.ru/articles/chem_opasna_bakteriya_khelikobakter_pilori.html?utm_source=vidal&utm_medium=infosite&utm_content=test3&utm_campaign=helinorm" target="_blank">Хеликобактер пилори</a> и готовьтесь к тому, что образ жизни и режим питания придется менять.',
          ),
        );
