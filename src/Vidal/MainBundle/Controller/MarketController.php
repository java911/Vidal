...
class MarketController extends Controller
{
	...
	public function mailSend($group, $order, Basket $basket)
	{
		...
		$this->get('email.service')->send(
			$order->getEmail(),
			array('VidalMainBundle:Email:market_notice_user.html.twig', array(
				'apteka' => $apteka,
				'group'  => $group,
				'order'  => $order,
				'basket' => $basket,
			...
			'Ваш заказ в интернет-аптеке ' . $apteka['title'],
			'apteka@vidal.ru'
		);
	...
	private function getApteka($group)
	{
		switch ($group) {
			case 'eapteka':
				return array('title' => '«EAPTEKA.RU»', 'phone' => '8 495 730-53-00, 8 800 775-03-33', 'link' => 'http://www.eapteka.ru');
			case 'piluli':
				return array('title' => '«PILULI.RU»', 'phone' => '8 495 926-36-428, 800 775-00-07', 'link' => 'http://www.piluli.ru');
			case 'wer':
				return array('title' => '«WER.RU»', 'phone' => '8 800 200-31-68, 8 495 989-87-03', 'link' => 'http://www.wer.ru');
			case 'zdravzona':
				return array('title' => '«ЗДРАВЗОНА»', 'phone' => '+7 495 225 45 89', 'link' => 'http://www.zdravzona.ru');
			default:
				return '';
		}
	}
