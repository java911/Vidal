...
class ExcelUsers2015Command extends ContainerAwareCommand
{
	protected function configure()
	{
		$this->setName('vidal:excel_users2015');
	}
	...
	protected function execute(InputInterface $input, OutputInterface $output)
	{
		...
		$users          = $em->getRepository('VidalMainBundle:User')->forExcel(2015);
		...
		$file = $this->getContainer()->get('kernel')->getRootDir() . DIRECTORY_SEPARATOR . '..'
			. DIRECTORY_SEPARATOR . 'web' . DIRECTORY_SEPARATOR . 'download' . DIRECTORY_SEPARATOR . 'users2015.xls';
