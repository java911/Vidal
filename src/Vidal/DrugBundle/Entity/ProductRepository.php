...
class ProductRepository extends EntityRepository
{
	public function findByProductID($ProductID)
	{
		return $this->_em->createQuery("
			SELECT p.ZipInfo, p.RegistrationNumber, p.DateOfIncludingText as RegistrationDate, ms.RusName MarketStatus, p.ProductID,
	...
	{
		return $this->_em->createQuery('
			SELECT p.ProductID, p.ZipInfo, p.RegistrationNumber, p.DateOfIncludingText as RegistrationDate, p.NonPrescriptionDrug,
				p.RusName, p.EngName, p.Name, p.NonPrescriptionDrug,
	...
	public function findByMoleculeID($MoleculeID)
	{
		return $this->_em->createQuery('
			SELECT p.ZipInfo, p.ProductID, p.RusName, p.EngName, p.Name, p.NonPrescriptionDrug,
				p.RegistrationNumber, p.DateOfIncludingText as RegistrationDate,
				d.Indication, d.DocumentID, d.ArticleID, d.RusName DocumentRusName, d.EngName DocumentEngName,
				d.Name DocumentName
			FROM VidalDrugBundle:Product p
			LEFT JOIN p.moleculeNames mn
	...
	public function findByQuery($q, $badIncluded = false)
	{
		...
		$qb
			->select('p.ZipInfo, p.RegistrationNumber, p.DateOfIncludingText as RegistrationDate, p.ProductID,
