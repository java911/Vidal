...
class ProductDocumentCommand extends ContainerAwareCommand
{
	...
	{
		$this->setName('vidal:v_product_document');
	}

	protected function execute(InputInterface $input, OutputInterface $output)
	{
		ini_set('memory_limit', -1);
		$output->writeln('--- vidal:v_product_document started');
		...
		$articlePriorities = array(1, 3, 4, 5, 2);
		...
		$output->writeln('+++ vidal:v_product_document completed!');
	}
}